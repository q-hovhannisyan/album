...
var script = {
  ...
  computed: {
    canFlipLeft: function() {
      return !this.flip.direction && this.currentPage >= this.displayedPages && !(this.displayedPages === 1 && !this.pageUrl(this.leftPage - 1));
    },
    canFlipRight: function() {
      return !this.flip.direction && this.currentPage < this.nPages - this.displayedPages;
    },
    canZoomIn: function() {
      return !this.zooming && this.zoomIndex < this.nZooms - 1;
    },
    canZoomOut: function() {
    ...
    cursor: function() {
      if (this.activeCursor) {
        ...
        return 'auto';
      } else if (this.zoomIndex < this.zooms.length - 1) {
        return 'zoom-in';
      } else {
        return 'zoom-out';
      }
    ...
    centerOffset: function() {
      var retval;
      retval = Math.round(this.viewWidth / 2 - (this.boundingLeft + this.boundingRight) / 2);
  ...
  methods: {
    onResize: function() {
      ...
      this.displayedPages = this.viewWidth > this.viewHeight ? 2 : 1;
      if (this.displayedPages === 2) {
        this.currentPage &= ~1;
      }
      if (this.displayedPages === 1 && !this.pageUrl(this.leftPage)) {
        this.currentPage++;
      }
      this.minX = 2e308;
    ...
    makePolygonArray: function(face) {
      ...
      if (this.displayedPages === 1 && direction === 'left') {
        progress = 1 - progress;
        direction = 'right';
      }
    ...
    flipStart: function(direction, auto) {
      ...
      if (direction === 'left') {
        if (this.displayedPages === 1) {
          ...
          this.flip.frontImage = this.pageUrl(this.leftPage);
        ...
        if (this.displayedPages === 1) {
          ...
          this.flip.frontImage = this.pageUrl(this.rightPage);
      ...
      return requestAnimationFrame(function () {
        return requestAnimationFrame(function () {
          if (this$1.flip.direction === 'left') {
            if (this$1.displayedPages === 2) {
              this$1.leftPage = this$1.currentPage - this$1.displayedPages;
            }
          } else {
            if (this$1.displayedPages === 1) {
              this$1.leftPage = this$1.currentPage + this$1.displayedPages;
            } else {
              this$1.rightPage = this$1.currentPage + 1 + this$1.displayedPages;
            }
          }
          if (auto) {
      ...
      animate = function () {
        return requestAnimationFrame(function () {
          ...
          if (ratio < 1) {
            ...
            if (this$1.displayedPages === 1 && this$1.flip.direction === 'right') {
      ...
      animate = function () {
        return requestAnimationFrame(function () {
          ...
          if (ratio > 0) {
            ...
            this$1.leftPage = this$1.currentPage;
            this$1.rightPage = this$1.currentPage + 1;
            if (this$1.displayedPages === 1 && this$1.flip.direction === 'left') {
              this$1.flip.direction = null;
            } else {
              this$1.onImageLoad(1, function () {
                return this$1.flip.direction = null;
    ...
    zoomIn: function() {
      ...
      this.zoomIndex += 1;
      return this.zoomTo(this.zooms[this.zoomIndex]);
    },
    zoomOut: function() {
      if (!this.canZoomOut) {
        return;
    ...
    zoomAt: function(touch) {
      ...
      this.zoomIndex = (this.zoomIndex + 1) % this.zooms.length;
      return this.zoomTo(this.zooms[this.zoomIndex], x, y);
    },
  ...
  watch: {
    pages: function() {
      return this.nPages = this.pages.length;
    },
...
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._t("default",null,null,{
    ...
    },style:({ cursor: _vm.cursor == 'grabbing' ? 'grabbing' : 'auto' }),on:{"touchmove":_vm.onTouchMove,"pointermove":_vm.onPointerMove,"mousemove":_vm.onMouseMove,"touchend":_vm.onTouchEnd,"touchcancel":_vm.onTouchEnd,"pointerup":_vm.onPointerUp,"pointercancel":_vm.onPointerUp,"mouseup":_vm.onMouseUp,"wheel":_vm.onWheel}},[_c('div',{staticClass:"container",style:({ transform: ("scale(" + _vm.zoom + ")"), })},[_c('div',{staticClass:"click-to-flip left",style:({ cursor: _vm.canFlipLeft ? 'pointer' : 'auto'}),on:{"click":_vm.flipLeft}}),_vm._v(" "),_c('div',{staticClass:"click-to-flip right",style:({ cursor: _vm.canFlipRight ? 'pointer' : 'auto'}),on:{"click":_vm.flipRight}}),_vm._v(" "),_c('div',{style:({ transform: ("translateX(" + _vm.centerOffsetSmoothed + "px)") })},[(_vm.pageUrl(_vm.leftPage, true))?_c('img',{staticClass:"page fixed",style:({
            width: _vm.pageWidth + 'px',
            height: _vm.pageHeight + 'px',
            left: _vm.xMargin + 'px',
            top: _vm.yMargin + 'px'
          }),attrs:{"src":_vm.pageUrl(_vm.leftPage, true)},on:{"load":function($event){return _vm.didLoadImage($event)}}}):_vm._e(),_vm._v(" "),(_vm.displayedPages === 2 && _vm.pageUrl(_vm.rightPage, true))?_c('img',{staticClass:"page fixed",style:({
            width: _vm.pageWidth + 'px',
            height: _vm.pageHeight + 'px',
            left: _vm.viewWidth / 2 + 'px',
            top: _vm.yMargin + 'px'
          }),attrs:{"src":_vm.pageUrl(_vm.rightPage, true)},on:{"load":function($event){return _vm.didLoadImage($event)}}}):_vm._e(),_vm._v(" "),_vm._l((_vm.polygonArray),function(ref){
          var key = ref[0];
          var bgImage = ref[1];
          var lighting = ref[2];
          var bgPos = ref[3];
...
return _c('div',{key:key,staticClass:"polygon",class:{ blank: !bgImage },style:({
            ...
            transform: transform,
            zIndex: z
          })},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(lighting.length),expression:"lighting.length"}],staticClass:"lighting",style:({ backgroundImage: lighting })})])}),_vm._v(" "),_c('div',{staticClass:"bounding-box",style:({
            left: _vm.boundingLeft + 'px',
            top: _vm.yMargin + 'px',
            width: _vm.boundingRight - _vm.boundingLeft + 'px',
            height: _vm.pageHeight + 'px',
            cursor: _vm.cursor
          }),on:{"touchstart":_vm.onTouchStart,"pointerdown":_vm.onPointerDown,"mousedown":_vm.onMouseDown}})],2)])])],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-559464e2_0", { source: ".viewport[data-v-559464e2]{-webkit-overflow-scrolling:touch;width:100%;height:100%}.viewport.zoom[data-v-559464e2]{overflow:scroll}.viewport.zoom.drag-to-scroll[data-v-559464e2]{overflow:hidden}.container[data-v-559464e2]{position:relative;width:100%;height:100%;-webkit-transform-origin:top left;transform-origin:top left;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.click-to-flip[data-v-559464e2]{position:absolute;width:50%;height:100%;top:0;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.click-to-flip.left[data-v-559464e2]{left:0}.click-to-flip.right[data-v-559464e2]{right:0}.bounding-box[data-v-559464e2]{position:absolute;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.page[data-v-559464e2]{position:absolute;-webkit-backface-visibility:hidden;backface-visibility:hidden}.polygon[data-v-559464e2]{position:absolute;top:0;left:0;background-repeat:no-repeat;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-origin:center left;transform-origin:center left}.polygon.blank[data-v-559464e2]{background-color:#ddd}.polygon .lighting[data-v-559464e2]{width:100%;height:100%}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-559464e2";
  /* module identifier */
  ...
  var Flipbook = normalizeComponent_1(
